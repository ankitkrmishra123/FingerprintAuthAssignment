...
class UserFriends_ProfilePage extends StatefulWidget {
  UserFriends_ProfilePage({Key key}) : super(key: key);

  @override
  _UserFriends_ProfilePageState createState() => _UserFriends_ProfilePageState();
}

class _UserFriends_ProfilePageState extends State<UserFriends_ProfilePage> {
  Profile profile;
